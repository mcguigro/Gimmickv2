...
public class LevelDoor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerPrefs.SetInt("Level 1 Factory", 1);//sets the sandbox level to unlocked
        PlayerPrefs.SetInt("Level 2 title", 1);//sets Monica Sandbox to unlocked
        PlayerPrefs.SetInt("Level 3 Title", 1);// sets CaveLevel to unlocked 
